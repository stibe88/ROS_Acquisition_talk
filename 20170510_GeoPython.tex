...
% Frame 2: Mobile Mapping
  \begin{frame}
   ...
   \begin{columns}[onlytextwidth]
    ...
    % TODO insert Image (outdoor Mobile Mapping)
...
% Frame 3: CTI-Project BIMAGE
  \begin{frame}
   ...
   \begin{columns}[onlytextwidth]
    ...
    % TODO insert Image (Logos FHNW / iNovitas / KTI)
...
\section{Software Requirements}
  ...
  \begin{frame}
   ...
   \begin{columns}[onlytextwidth]
    ...
    % TODO insert Image (imms protytype)
    
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
       \item IMMS prototype (see image) %TODO Link 
       \begin{itemize}
